...
namespace CheckDrive.Mobile.Views.Driver.Popups
{
    ...
    public partial class MechanicAcceptanceConfirmationPopup : PopupPage
    {
        public MechanicAcceptanceConfirmationPopup(
            ...
            CheckPointDto checkPoint)
        {
            ...
            BindingContext = new MechanicAcceptanceConfirmationViewModel(completionSource, checkPoint);
        }
    }
}