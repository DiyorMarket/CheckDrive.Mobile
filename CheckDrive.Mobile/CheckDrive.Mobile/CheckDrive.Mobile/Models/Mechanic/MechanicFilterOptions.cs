...
{
    public class MechanicFilterOptions
    {
        public DateTime MinDate { get; set; }
        public DateTime MaxDate { get; set; }
        public List<PickerItem<int?>> Drivers { get; set; }
        public List<PickerItem<int?>> Cars { get; set; }
        ...
        public MechanicFilterOptions(List<MechanicHistoryDto> histories, List<CarDto> cars)
        {
            ...
            Cars = cars.Select(x => new PickerItem<int?>(x.Id, x.ToString())).Distinct().ToList();
